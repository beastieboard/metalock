...
impl_into_rd3!(IntoRdBuf32, [], RD, *const [u8; 32], |self| from_ptr(BUF32::ID, 0, self));
...
fn pp<T>(discriminant: u8, extra: u8, t: T) -> RD {
    ...
    from_ptr(discriminant, extra, p)
}

fn from_ptr<T>(discriminant: u8, extra: u8, t: *const T) -> RD {
    unsafe {
